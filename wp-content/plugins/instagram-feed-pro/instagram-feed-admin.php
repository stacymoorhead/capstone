...
function sbi_welcome_screen_do_activation_redirect() {
    ...
    // $sbi_updated_plugin = get_option( 'sbi_page_id' );

    // if( ! $sbi_updated_plugin ) { // First time install
    //     // wp_safe_redirect( admin_url( 'admin.php?page=sbi-welcome-started' ) ); exit;
    //     wp_safe_redirect( admin_url( 'admin.php?page=sbi-welcome-new' ) ); exit;
    // } else { // Updated plugin
        wp_safe_redirect( admin_url( 'admin.php?page=sbi-welcome-started' ) ); exit;
    // }
}
