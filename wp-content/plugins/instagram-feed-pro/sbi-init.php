...
function display_sb_instagram_feed($atts, $content = null) {
	...
	if ( current_user_can( 'edit_posts' )
		...
		$sb_instagram_background = str_replace('#', '', 'fff');
		$sb_hover_background = $atts['hovercolor'];
		$sb_hover_text = str_replace('#', '', $atts['hovertextcolor']);
	}
	...
	/******************* CONTENT ********************/
    $sb_instagram_content = '<div id="sb_instagram" class="sbi' . $sbi_class . $sbi_class_moderation_mode . $sb_instagram_disable_mobile;
...
function sbi_update_comment_cache() {
	...
	//var_dump($comment_cache[$post_id]);
...
function sb_instagram_styles_enqueue() {
    wp_register_style( 'sb_instagram_styles', plugins_url('css/sb-instagram.css', __FILE__), array(), SBIVER, false );
}
...
function sb_instagram_scripts_enqueue() {
	...
	if ( isset( $sb_instagram_settings['enqueue_css_in_shortcode'] ) && $sb_instagram_settings['enqueue_css_in_shortcode'] ) {
		...
		wp_enqueue_style( 'sb_instagram_styles', plugins_url('css/sb-instagram.css', __FILE__), array(), SBIVER, false );
	}
