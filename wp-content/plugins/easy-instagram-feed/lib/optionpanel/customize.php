...
<table class="form-table">
    ...
    <hr />
		...
		<tr>
			...
			<input type="checkbox" name="light_box" id="light_box" value="yes" disabled=""><span style="font-style:Italic;"> <?php _e('Available in pro version','eif');?></span>
			</td>
		</tr>
...
<table class="form-table">
 <hr/>
	 ...
	 <tr valign="top">
		...
		<td>
			<input type="checkbox" name="header" value="yes" disabled=""><span style="font-style:Italic;"> <?php _e('Available in pro version','eif');?></span>
		</td>
	 </tr>
	 <tr valign="top">
	 <th scope="row"><label><?php _e('Header text color','eif');?></label></th>
	 <td style="display:none;">
			<input type="text" name="header_text_color" id="header_text_color" class="eif-color-field" ><span style="font-style:Italic;"> <?php _e('Available in pro version','eif');?></span>
		 </td></td><td><span style="font-style:Italic;"><?php _e('Available in pro version','eif');?></span></td>
		 </tr>
</table>
...
<table class="form-table">
 <hr/>
	 ...
	 <tr valign="top">
		...
		<td>
			<input type="checkbox" name="caption" value="yes" disabled=""> <span style="font-style:Italic;"> <?php _e('Available in pro version','eif');?></span>
		</td>
	 </tr>
	 <tr valign="top">
	 <th scope="row"><label><?php _e('Maximum text length','eif');?></label></th>
	 <td>
			<input type="text" name="text_length" id="text_length" disabled=""> <span style="font-style:Italic;"> <?php _e('Available in pro version','eif');?></span>
	 </td>
	 <tr>
	  <th scope="row"><label><?php _e('Text color','eif');?></label></th>
	 <td style="display:none;">
			<input type="text" name="caption_text_color" id="caption_text_color" class="eif-color-field" ><span style="font-style:Italic;"> <?php _e('Available in pro version','eif');?></span>
		 </td></td><td><span style="font-style:Italic;"><?php _e('Available in pro version','eif');?></span></td>
		 </tr>
		 <tr>
...
</select> <span style="font-style:Italic;"><?php _e('Available in pro version','eif');?></span>
		 </td>
		 </tr>
</table>
<table class="form-table">
 <hr/>
	 ...
	 <tr valign="top">
		...
		<td>
			<input type="checkbox" name="like_show" value="yes" disabled=""> <span style="font-style:Italic;"><?php _e('Available in pro version','eif');?></span>
		</td>
	 </tr>
	 <tr valign="top">
		<th scope="row"><label><?php _e('Show number of comments','eif');?></label></th>
		<td>
			<input type="checkbox" name="show_comments" value="yes" disabled=""> <span style="font-style:Italic;"><?php _e('Available in pro version','eif');?></span>
		</td>
	 </tr>
	  <tr valign="top">
	 ...
	 <td style="display:none;">
		 ...
		 </td><td><span style="font-style:Italic;"><?php _e('Available in pro version','eif');?></span></td>
		 </tr>
