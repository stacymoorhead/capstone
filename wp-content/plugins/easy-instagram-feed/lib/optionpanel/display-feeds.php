...
<p><?php _e("See the table below for a full list of available shortcode attributes:","eif"); ?></p>
	<table id="menu-locations-table" class="widefat fixed">
		...
		<tr id="menu-locations-row">
			<td class="wff-att-name"><?php echo('userid');?></td>
			<td class="wff-att-name"><?php echo('1591885187');?></td>
			<td class="wff-att-uses"><?php echo sprintf(__('An Instagram User ID. Want to fetch feeds from multiple user accounts than specify their IDs and separate them by commas. Use this tool to know your <a href="http://webriti.com/instagramuserid/instagramuserid.php" target="_blank">userid</a> . You can also get your id by authorizing this app in the General Settings of the Option Panel.','eif')); ?></td>
		</tr>
		<tr id="menu-locations-row">
			...
			<td class="wff-att-uses"><?php _e('An Instagram user access token. Again you can get the token  by authorizing this app from the general settings','eif'); ?></td>
		</tr>
		<tr id="menu-locations-row">
		...
		<tr>
		<th class="wff-att-name" style="  background: darkgray;" colspan="3" scope="col"><?php _e('Available Attributes in pro version','eif');?></th>
